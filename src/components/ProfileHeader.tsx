...
export default function ProfileHeader() {
  ...
  return (
    <div className="max-[600px]:w-screen max-[600px]:p-5 max-[600px]:mt-5 h-86 p-5 mt-20 flex flex-col gap-2 md:w-9/12 xl:w-9/12 2xl:w-8/12" >
      <div className="max-[600px]:w-screen flex md:w-full  h-28 p-2 flex-row items-center align-middle gap-2">
        ...
        <div className="max-[600px]:w-screen md:ml-2 w-full h-full flex align-middle justify-center flex-col ">
          ...
          <p className='font-normal text-sm mt-2'>Frontend Specialist at <Link className='font-bold' href={`https://www.arvore.com.br/`}>Árvore</Link> 🌳</p>
        </div>
      </div>
      <h2 className="text-2xl font-bold mt-2">Have a nice {date}! 🧑🏻‍💻</h2>
